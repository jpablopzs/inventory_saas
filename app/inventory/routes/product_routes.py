...
from app.inventory.controllers.product_controller import create_product, update_product, delete_product, list_products, read_product
...
async def list_products_route(
    ...
    return await list_products(db, company_id, skip=skip, limit=limit)
...
async def read_product_route(
    ...
    return await read_product(db, product_id, company_id)
